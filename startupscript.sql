...
insert into Ingredient values('Pepperoni', 'Y', 30, 25, 0, 0, 5, 'Meat');
insert into Ingredient values('Marinara', 'Y', 25, 15, 1, 3, 5, 'Other');
insert into Ingredient values('Noodles', 'N', 20, 20, 1, 2, 5, 'Grain');
insert into Ingredient values('Lettuce', 'N', 5, 5, 0, 0, 5, 'Vegetable');
insert into Ingredient values('Dressing', 'Y', 15, 15, 0, 15, 5, 'Other');
